    ...
    <div className="space-y-6 text-stone-800 font-sans text-xs pt-2 text-left">
      ...
      {activeTab === 'hero' && (
        <div className="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-4">
          <h5 className="text-sm font-bold text-[#1A1207] font-serif border-b pb-2">১. প্রকাশনা ও প্রকাশনী পরিচিতি ও ব্যানার</h5>
          ...
          <div className="p-4 border border-[#B8862A]/30 rounded-xl space-y-3 bg-[#FAF7F2]/40">
            <div className="flex items-center justify-between">
              <label className="text-xs font-bold text-stone-800 flex items-center gap-1.5">
                ...
                <span>প্রকাশনা মূল ব্যানার ছবি (Hero Banner Image)</span>
              </label>
            ...
            <div className="relative aspect-video max-h-48 w-full rounded-xl overflow-hidden border border-stone-200 bg-stone-900 shadow-xs">
              <img 
                src={editingPage.hero_image || publicationData.hero_image || '/assets/IMGS/534826832_1175889297895883_7988975073499309288_n.jpg'} 
              ...
              <button
                type="button"
                onClick={() => {
                  updatePubField('hero_image', '/assets/IMGS/534826832_1175889297895883_7988975073499309288_n.jpg');
                }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
              <div className="space-y-1">
                ...
                <input
                  type="text"
                  value={editingPage.hero_image || publicationData.hero_image || ''}
                  onChange={(e) => updatePubField('hero_image', e.target.value)}
              ...
              <div className="space-y-1">
                ...
                <label className="border-2 border-dashed border-[#2E5942]/40 rounded-lg p-2 bg-[#2E5942]/5 text-center hover:bg-[#2E5942]/10 hover:border-[#2E5942] transition flex items-center justify-center gap-2 cursor-pointer">
                  <input
                    ...
                    accept="image/*"
                    className="hidden"
                    disabled={uploading === 'pub_hero_image'}
                    onChange={(e) => handleFileUpload(e, (url) => {
                      updatePubField('hero_image', url);
                    }, 'pub_hero_image')}
                  />
                  <Upload className={`h-4 w-4 text-[#2E5942] ${uploading === 'pub_hero_image' ? 'animate-spin' : ''}`} />
                  <span className="text-xs font-bold text-[#2E5942]">
                    {uploading === 'pub_hero_image' ? 'আপলোড হচ্ছে...' : '📁 ব্যানার ছবি নির্বাচন করুন'}
                  </span>
                </label>
              </div>
            </div>
